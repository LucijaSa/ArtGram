...
public abstract class Hilt_ImagesByNicknameFragment<V extends BaseViewModel> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImagesByNicknameFragment_GeneratedInjector) this.generatedComponent()).injectImagesByNicknameFragment(UnsafeCasts.<ImagesByNicknameFragment>unsafeCast(this));
    }
  }
