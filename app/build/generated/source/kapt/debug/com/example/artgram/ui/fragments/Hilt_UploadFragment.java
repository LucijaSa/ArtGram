...
public abstract class Hilt_UploadFragment<V extends BaseViewModel> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UploadFragment_GeneratedInjector) this.generatedComponent()).injectUploadFragment(UnsafeCasts.<UploadFragment>unsafeCast(this));
    }
  }
